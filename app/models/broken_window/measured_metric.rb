module BrokenWindow
  class MeasuredMetric
    ...
    def threshold_measurements
      @threshold_measurements ||= daily_measurements.select do |measurement|
        measurement.value && (measurement.created_at > metric.threshold_period.days.ago.beginning_of_day)
      end
    end
  end
end
